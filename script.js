...
const CITY_TIPS = {
  ...
  // ── 국내 ──
  "Busan": ["4~6월 · 9~10월", "해운대 산책하기 좋은 온화한 날씨", "7~8월", "무더위와 휴가철 인파", "부산불꽃축제(11월) · 부산국제영화제(10월)"],
  "Jeju": ["4~6월 · 9~10월", "유채꽃과 억새, 쾌청한 하늘", "7~8월", "습한 더위와 태풍 경로", "제주 들불축제(3월) · 성산일출축제(12/31)"],
  "Incheon": ["4~5월 · 9~10월", "선선한 바닷바람", "7~8월", "장마와 무더위", "펜타포트 록 페스티벌(8월) · 소래포구 축제(9월)"],
  "Daegu": ["4~5월 · 10월", "벚꽃과 단풍", "7~8월", "전국 최고 수준의 폭염", "대구 치맥 페스티벌(7월) · 약령시 한방문화축제(5월)"],
  // ── 일본 ──
  "Fukuoka": ["3~5월 · 10~11월", "온화하고 먹거리 여행 최적", "6~7월", "장마철 집중호우", "하카타 기온 야마카사(7월) · 하카타 돈타쿠(5월)"],
  "Sapporo": ["6~8월 · 12~2월", "시원한 여름 / 눈축제와 설경", "3~4월", "진눈깨비 해빙기", "삿포로 눈축제(2월) · 요사코이 소란축제(6월)"],
  "Nagoya": ["3~5월 · 10~11월", "온화한 관광 시즌", "7~8월", "찜통 더위", "나고야마쓰리(10월) · 아츠타마쓰리(6월)"],
  "Naha": ["3~5월 · 10~11월", "해수욕 가능 + 태풍 회피", "8~9월", "태풍 직격 시즌", "나하 대줄다리기(10월) · 에이사 축제(8월)"],
  "Kyoto": ["3월 말~4월 · 11월", "벚꽃과 단풍의 절정", "7~8월", "분지 무더위와 관광 인파", "기온마쓰리(7월) · 아라시야마 하나토로(12월)"],
  "Hiroshima": ["3~5월 · 10~11월", "온화하고 쾌청", "6~7월", "장마", "히로시마 플라워 페스티벌(5월) · 평화기념식(8/6)"],
  "Takamatsu": ["4~5월 · 10~11월", "우동 여행하기 좋은 날씨", "6~7월", "장마", "사누키 다카마쓰마쓰리(8월)"],
  "Matsuyama": ["4~5월 · 10~11월", "도고온천과 성 산책 최적", "6~7월", "장마", "마쓰야마 가을축제(10월) · 도고온천 축제(3월)"],
  "Kagoshima": ["3~5월 · 10~11월", "온화한 남큐슈 날씨", "6~7월", "장마와 화산재", "오하라마쓰리(11월)"],
  "Kumamoto": ["3~5월 · 10~11월", "성과 온천 여행 최적", "6~7월", "장마 집중호우", "히노쿠니마쓰리(8월)"],
  "Miyazaki": ["3~5월 · 10~11월", "온화한 휴양 날씨", "6~9월", "태풍 상륙 잦음", "미야자키 신궁대제(10월)"],
  "Oita": ["4~5월 · 10~11월", "벳푸·유후인 온천 여행 최적", "6~7월", "장마", "벳푸 온천축제(4월)"],
  "Niigata": ["8월 · 12~2월", "여름 불꽃 / 스키·설경", "6~7월", "장마", "나가오카 불꽃대회(8월)"],
  "Sendai": ["4~5월 · 10~11월", "신록과 단풍", "12~2월", "눈과 추위", "센다이 다나바타 축제(8월)"],
  "Nagasaki": ["3~5월 · 10~11월", "항구 도시 산책 최적", "6~7월", "장마", "나가사키 랜턴 페스티벌(1~2월) · 나가사키 군치(10월)"],
  "Okayama": ["3~5월 · 10~11월", "'맑음의 나라'다운 쾌청함", "6~7월", "장마", "사이다이지 하다카마쓰리(2월)"],
  "Shizuoka": ["10~12월 · 3~5월", "후지산 조망 확률 최고", "6~7월", "장마", "시즈오카 마쓰리(4월)"],
  "Asahikawa": ["6~8월 · 1~2월", "시원한 여름 / 겨울축제", "11~12월", "폭설 시작", "아사히카와 겨울축제(2월)"],
  // ── 중국·대만·홍콩·마카오 ──
  "Guangzhou": ["10~12월", "건조하고 선선한 최적기", "4~9월", "우기와 무더위", "광저우 춘절 꽃시장(1~2월) · 캔톤페어(4·10월)"],
  "Shenzhen": ["10~12월", "쾌적한 건기", "4~9월", "우기와 태풍", "선전 등불축제(2월)"],
  "Chengdu": ["3~5월 · 9~11월", "판다 기지 관람 쾌적", "7~8월", "무더위", "청두 등불축제(2월)"],
  "Xi'an": ["3~5월 · 9~10월", "병마용 관광 최적", "7~8월", "폭염", "시안 성벽 등불축제(2월)"],
  "Qingdao": ["5~10월", "해변과 맥주의 계절", "12~2월", "차가운 해풍", "칭다오 국제맥주축제(7~8월)"],
  "Yantai": ["5~10월", "해변 휴양 시즌", "12~2월", "추위", "옌타이 국제 와인 페스티벌(9월)"],
  "Weihai": ["5~10월", "쾌적한 해안 도시", "12~2월", "추위", "웨이하이 국제 해변축제(7~8월)"],
  "Dalian": ["5~10월", "시원한 해양성 기후", "12~2월", "칼바람", "다롄 벚꽃축제(4~5월) · 국제 패션제(9월)"],
  "Shenyang": ["5~9월", "온화한 계절", "12~2월", "영하 20°C 혹한", "선양 국제 빙설제(1~2월)"],
  "Harbin": ["6~8월 · 12~2월", "시원한 여름 / 빙등제", "3~4월", "해빙기 진창", "하얼빈 국제 빙설제(1~2월)"],
  "Tianjin": ["4~5월 · 9~10월", "쾌청한 계절", "7~8월", "무더위", "톈진 춘절 묘회(1~2월)"],
  "Nanjing": ["3~5월 · 9~11월", "고도(古都) 산책 최적", "7~8월", "'화로 도시' 폭염", "친화이 등불축제(2월)"],
  "Hangzhou": ["3~5월 · 9~11월", "서호의 봄과 가을", "7~8월", "폭염", "용정차 축제(4월) · 서호 박람회(10월)"],
  "Wuhan": ["3~5월 · 9~11월", "벚꽃과 가을 단풍", "7~8월", "3대 화로 폭염", "우한 벚꽃축제(3월)"],
  "Changsha": ["3~5월 · 9~11월", "쾌적한 관광 시즌", "7~8월", "폭염", "오렌지섬 불꽃쇼(여름 주말)"],
  "Kunming": ["3~5월", "'봄의 도시' 연중 온화", "6~8월", "우기", "윈난 횃불축제(7~8월)"],
  "Macau": ["10~12월", "건조하고 쾌적", "5~9월", "태풍과 습한 더위", "마카오 그랑프리(11월) · 국제 불꽃대회(9~10월)"],
  "Kaohsiung": ["10~3월", "따뜻한 겨울 휴양", "6~9월", "태풍과 무더위", "가오슝 등불축제(2월)"],
  "Taichung": ["10~3월", "온화한 날씨", "6~9월", "태풍 시즌", "타이중 재즈 페스티벌(10월)"],
  // ── 동남아 휴양지 ──
  "Cebu": ["12~5월", "건기, 다이빙·호핑 최적", "7~10월", "우기와 태풍", "시눌룩 축제(1월)"],
  "Angeles": ["12~2월", "선선한 건기", "6~10월", "우기", "클락 열기구 축제(1~2월)"],
  "Boracay": ["11~5월", "건기, 화이트비치 최적", "6~10월", "몬순 파도와 비", "아티아티한 축제(1월)"],
  "Duong Dong": ["11~3월", "푸꾸옥 건기, 잔잔한 바다", "6~9월", "우기", "딘꺼우 사원 축제(음력 10월)"],
  "Nha Trang": ["2~8월", "긴 건기, 해양 액티비티", "9~12월", "우기 집중호우", "나트랑 바다축제(6월, 격년)"],
  "Ho Chi Minh City": ["12~4월", "건기, 도시 관광 쾌적", "5~11월", "우기 스콜", "뗏 꽃거리 축제(1~2월)"],
  "Haiphong": ["10~12월", "하롱베이 관문, 선선한 건기", "6~8월", "폭염과 태풍", "깟바 관광축제(4월)"],
  "Da Lat": ["12~3월", "'영원한 봄' 고원의 건기", "6~9월", "우기", "달랏 꽃축제(12월, 격년)"],
  "Chiang Mai": ["11~2월", "건기, 선선한 북부 산악", "3~4월", "화전 연무로 대기질 최악", "이뻥 풍등축제(11월) · 송끄란(4월)"],
  "Phuket": ["11~4월", "건기, 바다 잔잔", "5~10월", "몬순 파도", "푸켓 채식축제(10월) · 송끄란(4월)"],
  "Penang": ["12~3월", "비교적 건조", "9~11월", "우기", "조지타운 페스티벌(7월) · 타이푸삼(1~2월)"],
  "Kota Kinabalu": ["2~4월", "건기, 섬 호핑 최적", "10~12월", "우기", "카아마탄 추수축제(5월)"],
  "Denpasar": ["4~10월", "발리 건기, 서핑·요가 시즌", "11~3월", "우기", "녜피 침묵의 날(3월) · 갈룽안(210일 주기)"],
  "Phnom Penh": ["11~2월", "건기, 선선", "5~10월", "우기", "본옴뚝 물축제(11월)"],
  "Siem Reap": ["11~2월", "앙코르와트 관광 최적 건기", "4~10월", "4월 폭염, 이후 우기", "크메르 새해(4월) · 앙코르 하프마라톤(12월)"],
  "Vientiane": ["11~2월", "건기, 선선", "5~10월", "우기", "탓루앙 축제(11월)"],
  "Luang Prabang": ["11~2월", "건기, 아침 탁발 산책 최적", "5~10월", "우기", "라오스 새해 삐마이(4월)"],
  "Yangon": ["11~2월", "건기", "5~10월", "몬순 폭우", "띤잔 물축제(4월) · 따딘쥿 빛축제(10월)"],
  // ── 중앙아시아·서남아·중동 ──
  "Ulaanbaatar": ["6~8월", "초원의 계절", "11~2월", "영하 30°C 혹한", "나담 축제(7월)"],
  "Tashkent": ["4~6월 · 9~10월", "온화한 실크로드 여행", "7~8월", "폭염", "나브루즈 봄축제(3월)"],
  "Almaty": ["4~6월 · 9~10월", "톈산 산맥 조망 쾌청", "12~2월", "추위", "나우르즈(3월) · 알마티 마라톤(4월)"],
  "Astana": ["5~9월", "짧고 쾌적한 여름", "11~3월", "극한의 초원 추위", "나우르즈(3월) · 수도의 날(7/6)"],
  "Bishkek": ["4~6월 · 9~10월", "산악 트레킹 최적", "12~2월", "추위", "나우르즈(3월)"],
  "Colombo": ["12~3월", "서남해안 건기", "5~9월", "몬순", "베삭 연등축제(5월) · 캔디 페라헤라(7~8월)"],
  "Kathmandu": ["10~11월 · 3~4월", "히말라야 조망 최고의 계절", "6~9월", "몬순", "다샤인(10월) · 티하르 빛축제(10~11월)"],
  "Doha": ["11~3월", "야외활동 가능한 계절", "6~9월", "폭염", "카타르 국경일(12/18) · 도하 문화축제(3월)"],
  "Abu Dhabi": ["11~3월", "쾌적한 사막의 겨울", "6~9월", "폭염", "F1 아부다비 그랑프리(11~12월)"],
  "Tel Aviv": ["4~6월 · 9~11월", "지중해 해변 최적기", "7~8월", "습한 더위", "텔아비브 프라이드(6월) · 화이트 나이트(6월)"],
  // ── 유럽 (추가 취항지) ──
  "Frankfurt": ["5~9월", "야외 카페의 계절", "11~1월", "흐리고 어두운 겨울", "프랑크푸르트 도서전(10월) · 크리스마스 마켓(12월)"],
  "Munich": ["5~10월 초", "여름 + 옥토버페스트", "11~2월", "춥고 흐림", "옥토버페스트(9~10월) · 크리스마스 마켓(12월)"],
  "Milan": ["4~6월 · 9~10월", "쾌적한 도시 관광", "7~8월", "무더위, 상점 휴업", "밀라노 패션위크(2·9월) · 디자인위크(4월)"],
  "Venice": ["4~6월 · 9~10월", "곤돌라 타기 좋은 날씨", "11~12월", "아쿠아 알타(침수) 시즌", "베네치아 카니발(2월) · 비엔날레(5~11월)"],
  "Lisbon": ["3~6월 · 9~10월", "온화한 대서양 기후", "8월", "폭염", "산투 안토니우 축제(6월)"],
  "Budapest": ["4~6월 · 9~10월", "온천과 야경 산책 최적", "12~2월", "추위", "시게트 페스티벌(8월) · 부다페스트 봄축제(4월)"],
  "Warsaw": ["5~9월", "긴 해와 야외 공연", "11~2월", "춥고 어두움", "쇼팽 야외 콘서트(여름) · 바르샤바 가을 음악제(9월)"],
  "Copenhagen": ["5~8월", "긴 백야에 가까운 여름", "11~2월", "어둡고 바람 많음", "코펜하겐 재즈 페스티벌(7월) · 티볼리 크리스마스(11~12월)"],
  "Oslo": ["5~8월", "피오르 여행 최적", "11~1월", "짧은 해", "제헌절 퍼레이드(5/17) · 오슬로 재즈(8월)"],
  "Stockholm": ["5~8월", "군도 여행의 계절", "11~1월", "어두운 겨울", "미드섬머(6월) · 노벨상 시상식(12월)"],
  "Helsinki": ["5~8월", "백야의 여름", "11~1월", "극야에 가까운 어둠", "바푸(5/1) · 헬싱키 축제(8월)"],
  "Brussels": ["5~9월", "쾌적한 날씨", "11~2월", "잦은 비", "플라워 카펫(8월, 짝수해)"],
  "Geneva": ["5~9월", "레만호와 알프스 조망", "11~2월", "흐림", "제네바 축제(8월) · 국제 모터쇼(3월)"],
  "Nice": ["5~10월", "지중해 해변 시즌", "11~2월", "온화하나 비수기", "니스 카니발(2월)"],
  // ── 미주·대양주 (추가 취항지) ──
  "Seattle": ["7~9월", "건조하고 화창한 최고의 여름", "11~3월", "우중충한 비의 계절", "시애틀 시페어(7~8월) · 벚꽃축제(4월)"],
  "Las Vegas": ["3~5월 · 10~11월", "사막 기후가 쾌적한 시기", "7~8월", "45°C 사막 폭염", "CES(1월) · 내셔널 파이널 로데오(12월)"],
  "Dallas": ["3~5월 · 10~11월", "온화한 계절", "7~8월", "폭염", "텍사스 주박람회(9~10월)"],
  "Atlanta": ["3~5월 · 9~11월", "쾌적한 남부 날씨", "7~8월", "습한 더위", "피치트리 로드레이스(7/4) · 드래곤콘(9월)"],
  "Boston": ["5~6월 · 9~10월", "뉴잉글랜드 단풍과 봄", "1~2월", "폭설", "보스턴 마라톤(4월) · 독립기념일 불꽃(7/4)"],
  "Washington": ["3월 말~4월", "포토맥 벚꽃 만개", "7~8월", "습한 더위", "내셔널 벚꽃축제(3~4월) · 독립기념일 퍼레이드(7/4)"],
  "Minneapolis": ["6~9월", "호수의 도시 여름", "12~2월", "극한 혹한", "미네소타 주박람회(8~9월)"],
  "Detroit": ["5~9월", "온화한 계절", "12~2월", "혹한", "디트로이트 오토쇼(9월) · 무브먼트 페스티벌(5월)"],
  "Hagatna": ["12~6월", "괌 건기, 휴양 최적", "8~10월", "태풍 시즌", "미크로네시아 아일랜드 페어(5월)"],
  "Saipan": ["12~6월", "건기, 스노클링 최적", "8~10월", "태풍 시즌", "사이판 마라톤(3월) · 플레임트리 축제(4월)"],
  "Brisbane": ["9~11월 · 3~5월", "온화한 아열대 봄가을", "12~2월", "무더위와 뇌우", "브리즈번 페스티벌(9월) · 에카 박람회(8월)"],
  "Cairns": ["5~10월", "건기, 산호초 다이빙 최적", "11~4월", "우기와 해파리 시즌", "케언스 페스티벌(8~9월)"],
  "Nadi": ["5~10월", "피지 건기", "11~4월", "우기와 사이클론", "불라 페스티벌(7월) · 히비스커스 축제(8월)"],
};

/* 여행 타이밍 가이드 렌더링 — 좋은 때/피할 때(이유 포함) + 축제 */
function renderTravelTips(cityName) {
  // 발음기호(São 등) 제거 후 비교해 OpenWeather 도시명과 매칭.
  // OWM 이 'Cebu City', 'Frankfurt am Main' 처럼 긴 이름을 주는 경우도
  // 단어 경계 기준 접두 일치로 흡수
  const norm = (s) =>
    s.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g, "");
  const target = norm(cityName);
  const key = Object.keys(CITY_TIPS).find((k) => {
    const a = norm(k);
    return a === target || target.startsWith(a + " ") || a.startsWith(target + " ");
  });
  ...
  const cityKo =
    (WORLD_CITIES.find((c) => c[1] === key) || [])[0] ||
    Object.keys(CITY_ALIASES).find((ko) => CITY_ALIASES[ko] === key) ||
    key;
